...
// ============================================================================
const CompanyHeader = ({ company, onReport }) => {
  const sizeLabels = {
    small: "1-50",
    medium: "51-200",
    large: "201-500",
                    ...
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-slate-600">
                      ...
                      {company.size && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="font-medium">
                            {sizeLabels[company.size]} nhân viên
                          </span>
                        </div>
                      )}
  ...
  const content = (
    <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors group">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p
          className={`text-sm font-semibold break-all ${href ? "text-blue-600 group-hover:text-blue-700" : "text-slate-700"}`}
        >
          {value}
...
const CompanyProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Company Header */}
      <CompanyHeader company={company} onReport={() => setReportOpen(true)} />
        ...
        {activeJobs.length === 0 && (
          <div className="mt-12 bg-white rounded-2xl border border-slate-200 p-16 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-slate-600">
                {company.name} hiện tại chưa có vị trí tuyển dụng nào. Hãy theo
                dõi để cập nhật các cơ hội mới nhất.
              </p>
            </div>
          </div>
        )}
